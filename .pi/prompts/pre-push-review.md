...
|----------|-----------------|-----------------|--------|
| security | `kimi-k2.6` | `medium` | Extended thinking catches subtle/chained vulnerabilities |
| code-quality | `deepseek-v4-pro` or `kimi-k2.5` | none | Good balance of cost and capability |
| frontend | `deepseek-v4-pro` or `kimi-k2.5` | none | Needs good pattern recognition |
| design | `deepseek-v4-flash` | none | Deterministic rules, cheaper is fine |
| infrastructure | `deepseek-v4-pro` or `kimi-k2.5` | none | Needs good understanding of Terraform/AWS |
