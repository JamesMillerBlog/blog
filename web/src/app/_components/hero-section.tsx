  ...
  return (
    <section className="mb-24 pt-32 max-w-3xl">
      ...
      <p className="font-body text-xl md:text-2xl text-on-surface-variant leading-relaxed">
        {hero.body.intro} <span className="text-primary font-bold">{hero.body.creative}</span>{' '}
        {hero.body.explore} <span className="text-primary font-bold">{hero.body.technology}</span>{' '}
        {hero.body.midText}{' '}
        <span className="text-primary font-bold">{hero.body.solveProblems}</span>
        {hero.body.thenText} <span className="text-primary font-bold">{hero.body.ship}</span>{' '}
        <span className="text-primary font-bold">{hero.body.products}</span> {hero.body.andText}{' '}
