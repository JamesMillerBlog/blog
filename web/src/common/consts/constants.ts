...
export const FEATURED_TAGS = [
  ...
  "Amazon Web Services", "Spacial Computing",
  "DevOps", "Blockchain", "Front End", "Back End"
];
...
export const FEATURED_TAG_MAP: Record<string, string[]> = {
  ...
  "Back End": ["node", "lambda", "serverless", "serverlessframework", "sls", "aws", "amazonwebservices", "amazoncognito"],
};
